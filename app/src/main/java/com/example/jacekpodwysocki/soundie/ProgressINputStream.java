...
/**
* source: http://www.java2s.com/Code/Android/File/InputStreamthatnotifieslistenersofitsprogress.htm
 */
...
public class ProgressInputStream extends InputStream {
    ...
    public ProgressInputStream(InputStream in, long size, Object tag) {
